        ...
        columns: [
            { data: 'item_id' },
            {
                ...
                render: function (data, type, row) {
                    return `<img src="http://localhost:3000/images/${data.product_image}" width="50" height="60">`;
                }
            },
    ...
    $('#itable tbody').on('click', 'a.editBtn', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#iform").append(`<img src="http://localhost:3000/images/${result[0].product_image}" width='200px', height='200px' id="itemImage"   />`)
